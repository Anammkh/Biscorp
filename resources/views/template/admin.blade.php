            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="index.html"><img src="biscorp.png" alt="Logo"srcset="">BS</a>
                        </div>
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item {{ request()->routeIs('jabatan.index') ? 'active' : '' }}">
                        ...
                        <li class="sidebar-item  {{ request()->routeIs('artikels.index') ? 'active' : '' }}">
